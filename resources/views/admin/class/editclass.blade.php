...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
        ...
        <form class="forms-sample" action="{{ url('admin/updateclass/'.$id->id) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control form-control-sm"name="max" value="{{ $id->max }}" aria-label="Username">
            </div>
